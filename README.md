...
## Streamlit UI (starter)

A basic Streamlit app is available at `apps/streamlit_app.py`. It is intentionally
a thin UI layer over `diamond_rca.ui.service` so you can later expose the same
service logic behind an API for a React frontend.
